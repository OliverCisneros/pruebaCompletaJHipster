...
import org.jhipster.blog.PruebaCompletaJHipsterApp;

import org.jhipster.blog.domain.WishList;
import org.jhipster.blog.repository.WishListRepository;
...
@SpringBootTest(classes = PruebaCompletaJHipsterApp.class)
public class WishListResourceIntTest {
    ...
    private static final Boolean DEFAULT_ESCONDIDO = false;
    private static final Boolean UPDATED_ESCONDIDO = true;
    ...
    public void createWishList() throws Exception {
        ...
        assertThat(testWishList.getNombre()).isEqualTo(DEFAULT_NOMBRE);
        assertThat(testWishList.getFechaCreacion()).isEqualTo(DEFAULT_FECHA_CREACION);
        assertThat(testWishList.isEscondido()).isEqualTo(DEFAULT_ESCONDIDO);
    }
    ...
    public void getAllWishLists() throws Exception {
        ...
        restWishListMockMvc.perform(get("/api/wish-lists?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].escondido").value(hasItem(DEFAULT_ESCONDIDO.booleanValue())));
    }
    ...
    public void getWishList() throws Exception {
        ...
        restWishListMockMvc.perform(get("/api/wish-lists/{id}", wishList.getId()))
            ...
            .andExpect(jsonPath("$.escondido").value(DEFAULT_ESCONDIDO.booleanValue()));
    }
    ...
    public void updateWishList() throws Exception {
        ...
        WishList testWishList = wishListList.get(wishListList.size() - 1);
        assertThat(testWishList.getNombre()).isEqualTo(UPDATED_NOMBRE);
        assertThat(testWishList.getFechaCreacion()).isEqualTo(UPDATED_FECHA_CREACION);
        assertThat(testWishList.isEscondido()).isEqualTo(UPDATED_ESCONDIDO);
    }
