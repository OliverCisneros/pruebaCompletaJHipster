...
import org.jhipster.blog.repository.WishRepository;
import org.jhipster.blog.service.WishService;
...
public class WishResourceIntTest {
    ...
    public void createWish() throws Exception {
        ...
        assertThat(testWish.getPrecio()).isEqualTo(DEFAULT_PRECIO);
    }
    ...
    public void updateWish() throws Exception {
        ...
        assertThat(testWish.getPrecio()).isEqualTo(UPDATED_PRECIO);
    }
