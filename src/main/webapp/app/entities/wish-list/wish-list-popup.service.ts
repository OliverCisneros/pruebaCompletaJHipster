        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.wishListService.find(id).subscribe((wishList) => {
                    if (wishList.fechaCreacion) {
                        wishList.fechaCreacion = {
                            year: wishList.fechaCreacion.getFullYear(),
                            month: wishList.fechaCreacion.getMonth() + 1,
                            day: wishList.fechaCreacion.getDate()
                        };
                    }
