...
@EnableZuulProxy
public class PruebaCompletaJHipsterApp {

    private static final Logger log = LoggerFactory.getLogger(PruebaCompletaJHipsterApp.class);

    private final Environment env;

    public PruebaCompletaJHipsterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes pruebaCompletaJHipster.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PruebaCompletaJHipsterApp.class);
